...
//  EssentialFeedTests
//
//  Created by Gideon Benz on 19/03/22.
//
...
extension FeedStoreSpecs where Self: XCTestCase {
    ...
    func assertThatSideEffectsRunSerially(on sut: FeedStore, file: StaticString = #file, line: UInt = #line) {
        ...
        XCTAssertEqual(completedOperations, [op, op2, op3], "Expected side-effects to run serially but operations finished in the wrong order", file: file, line: line)
    }
}
