...
class RemoteFeedImageDataLoaderTests: XCTestCase {
    ...
    func test_loadImageDataFromURL_doesNotDeliverResultAfterCancellingTask() {
        ...
        XCTAssertTrue(received.isEmpty, "Expected no received result after canceling task")
    }
    
    func test_loadImageDataFromURL_doesNotDeliverResultAfterTheSUTInstanceHasBeenDeallocated() {
