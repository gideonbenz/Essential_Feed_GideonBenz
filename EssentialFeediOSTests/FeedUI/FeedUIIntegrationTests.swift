...
final class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_loadFeedAction_requestFromLoader() {
    ...
    func test_loadingFeedIndicator_isVisibleWhileLoadingFeed() {
        ...
        XCTAssertFalse(sut.isShowingLoadingIndicator, "Expected no loading once loading is completes successfully")
        
        sut.simulateUserInitiatedFeedReload()
        XCTAssertTrue(sut.isShowingLoadingIndicator, "Expected loading indicator once user initiates a reload")
        
        loader.completeFeedLoadingWithError(at: 1)
        XCTAssertFalse(sut.isShowingLoadingIndicator, "Expected no loading once loading indicator once user initiated loading completes with error")
    }
    ...
    func test_feedImageViewLoadingIndicator_isVisibleWhiteLoadingIndicator() {
        let (sut, loader) = makeSUT()
    ...
    func test_feedImageView_rendersImageLoadedFromURL() {
        ...
        XCTAssertEqual(view1?.renderedImage, .none, "Expected no image change for second view once first image loading completes successfully")
