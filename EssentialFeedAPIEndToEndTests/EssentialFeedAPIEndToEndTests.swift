...
//
//  Created by Gideon Benz on 18/02/22.
//
...
class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    private func getFeedImageData(file: StaticString = #file, line: UInt = #line) -> FeedImageDataLoader.Result? {
